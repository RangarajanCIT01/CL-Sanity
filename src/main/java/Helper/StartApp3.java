...
public class StartApp3 {
	...
	public AndroidDriver<MobileElement> startApp_Mobile(String platformVersion, String deviceName) throws IOException, InterruptedException {
	...
	public void startAppiumServer2() {
		runtime = Runtime.getRuntime();
		try {
